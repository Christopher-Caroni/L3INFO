...
public class Mot {
    ...
    private int[] calculerFonctionPrefixe(Mot motif) {
        ...
        for (int q = 2; q < motif.length(); q++) {
            while (k > 0 && motif.toString().charAt(k) != motif.toString().charAt(q)) {
                k = pref[k];
            }
    ...
    public static void main(String args[]) {
        ...
        */
        ...
        Mot mot = new Mot("testdeguillaume");
        System.out.println("On veut trouver \"gui\" dans \"" + mot.toString() + "\"");
        System.out.println("indice: " + mot.indiceMotifKMP(new Mot("gui")));
    }
